...
import static org.springframework.cloud.appbroker.integration.CreateInstanceWithParametersMappingComponentTests.APP_NAME;
...
class CreateInstanceWithParametersMappingComponentTests extends WiremockComponentTests {
	...
	void pushAppWithParametersTransformedToEnvironmentVariables() {
		...
		this.cloudControllerFixture.stubPushApp(APP_NAME,
				...
				matchingJsonPath("$.[?(@.instances == '2')]"), matchingJsonPath("$.[?(@.memory == '2048')]"));
