...
class PropertyMappingParametersTransformerFactoryTests {

	private ParametersTransformer<BackingApplication> transformer;

	@BeforeEach
	void setUp() {
		this.transformer = new PropertyMappingParametersTransformerFactory()
			.createWithConfig((config) -> config.setInclude("count,memory"));
	}
