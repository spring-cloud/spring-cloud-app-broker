...
class s {
	...
	void transformParametersWithNoBackingApps() {
		...
		BackingApplications backingApplications = BackingApplications.builder().build();

		StepVerifier.create(service.transformParameters(backingApplications, new HashMap<>()))
	...
	void transformParametersWithTransformers() {
		...
		BackingApplication app1 = BackingApplication.builder()
			.name("app1")
			.parameterTransformers(ParametersTransformerSpec.builder().name("transformer1").build())
			.build();
		BackingApplication app2 = BackingApplication.builder()
			...
			.parameterTransformers(ParametersTransformerSpec.builder()
				...
				.arg("arg1", "value1")
				.arg("arg2", 5)
				.build(), ParametersTransformerSpec.builder().name("transformer2").build())
			.build();
		BackingApplications backingApplications = BackingApplications.builder()
		...
		StepVerifier.create(service.transformParameters(backingApplications, parameters))
	...
	public static class Config {
		...
		public boolean equals(Object o) {
			...
			return Objects.equals(this.arg2, config.arg2) && Objects.equals(this.arg1, config.arg1);
		}
		...
		public String toString() {
			return "Config{" + "arg1='" + this.arg1 + '\'' + ", arg2=" + this.arg2 + '}';
		}
