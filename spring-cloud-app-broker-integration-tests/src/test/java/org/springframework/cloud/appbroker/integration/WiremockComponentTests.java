...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
		classes = { AppBrokerApplication.class, WiremockServerFixture.class, OpenServiceBrokerApiFixture.class,
				CloudControllerStubFixture.class, UaaStubFixture.class },
		properties = { "spring.cloud.appbroker.deployer.cloudfoundry.api-host=localhost",
...
class WiremockComponentTests {
	...
	@AfterAll
	void tearDown() {
		this.wiremockFixture.stopWiremock();
	}
	...
	@AfterEach
	void verifyStubs() {
		this.wiremockFixture.verifyAllRequiredStubsUsed();
	}
