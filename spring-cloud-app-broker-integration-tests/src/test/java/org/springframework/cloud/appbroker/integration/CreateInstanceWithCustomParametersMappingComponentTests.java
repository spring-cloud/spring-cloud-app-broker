...
import static org.springframework.cloud.appbroker.integration.CreateInstanceWithCustomParametersMappingComponentTests.APP_NAME;
...
@ContextConfiguration(classes = CreateInstanceWithCustomParametersMappingComponentTests.CustomConfig.class)
class CreateInstanceWithCustomParametersMappingComponentTests extends WiremockComponentTests {

	private static final Logger LOG = LoggerFactory
		.getLogger(CreateInstanceWithCustomParametersMappingComponentTests.class);
	...
	void pushAppWithParametersTransformedUsingCustomTransformer() {
		...
		this.cloudControllerFixture.stubPushApp(APP_NAME, matchingJsonPath(
		...
		given(this.brokerFixture.serviceInstanceRequest(params)).when()
	...
	protected static class CustomConfig {
		...
		public final class CustomMappingParametersTransformerFactory
			...
			private Map<String, Object> createEnvironmentMap(Map<String, Object> parameters) {
				...
				try {
					CustomInputParameters customInputParameters = objectMapper
						.readValue(parameters.get("firstKey").toString(), CustomInputParameters.class);
					...
					if (LOG.isDebugEnabled()) {
						LOG.debug("error reading parameters", ex);
					}
				}
		...
		private static final class CustomInputParameters {
			...
			void setSecondKey(String secondKey) {
