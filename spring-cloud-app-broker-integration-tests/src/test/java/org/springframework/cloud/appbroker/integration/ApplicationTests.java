...
class ApplicationTests {
	...
	void applicationInitialized() {
		assertThat(this.catalogController).isNotNull();
		assertThat(this.cloudFoundryOperations).isNotNull();
		assertThat(this.appDeployer).isNotNull();
		assertThat(this.deploymentService).isNotNull();
		assertThat(this.serviceInstanceService).isNotNull();
	}
